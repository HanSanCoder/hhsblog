    ...
    //网站最后更新时间（版本更新需更改）
    var siteLastUpdateTime = '2023年4月22日19点';

    //网站开始时间
    var siteBeginRunningTime = '2023-06-22 20:00:00';
    ...
    $('.myCardBtn').click(function () {
        $('.qq_code').attr("src","https://hhsblog.oss-cn-beijing.aliyuncs.com/static/img/qq_code.png");
        $('.weixin_code').attr("src","https://hhsblog.oss-cn-beijing.aliyuncs.com/static/img/weixin_code.png");
    });
