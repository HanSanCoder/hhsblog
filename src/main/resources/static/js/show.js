    ...
    function putInArticle(data) {
        ...
        var articleTop = $('<article-top><div class="article-title">' +
            ...
            '多年以后，愿你的城市，有清风，有烈酒，也有人是你的归途。<span class="article-i-say-me">--- 何汉叁</span>' +
            '</div>');
        ...
        var articleFooter = $('<div class="end-logo">' +
            ...
            '<img src="http://hhsblog.oss-cn-beijing.aliyuncs.com/static/img/weixin_code.png">' +
            '</p>' +
            '<p class="show-weixin-pic">欢迎关注我的微信公众号：目前没打算建（微信号代替啦）</p>' +
